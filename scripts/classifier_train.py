...
def main():
    ...
    puge_model = nn.Sequential(puge_model,nn.Conv2d(in_channels=6,out_channels=3,kernel_size=1))
    ...
    mp_trainer = MixedPrecisionTrainer(
        model=puge_model, use_fp16=args.classifier_use_fp16, initial_lg_loss_scale=13.0
    )
...
def create_argparser():
    defaults = dict(
        ...
        resume_checkpoint="/home/zeyu/fht/diffusion/guided-diffusion/models/trained_model/model000075.pt",
        log_interval=10,
        eval_interval=5,
        save_interval=1,
        nums_gpus = 4
